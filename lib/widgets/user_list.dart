...
class UserList extends StatelessWidget {
  const UserList({super.key, required this.title, required this.activeUsers, required this.onTapUser});
        ...
        child: Card(
          ...
          child: Padding(
            ...
            Padding(
              ...
              child: Text(title, style: const TextStyle(fontSize: 16.0, letterSpacing: 1.0),),
            ),
            Expanded(
